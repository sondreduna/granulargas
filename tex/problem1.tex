...
To have a more quantitative measure of how good the fit is, divide the real line into $k$ intervals consider the normalized $\ell^1$-norm of the difference at each interval 
